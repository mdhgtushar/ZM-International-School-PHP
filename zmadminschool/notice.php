            ...
            <div class="container">
                <div class="wdlf"> 
                    ...
                    <div class="" style="width: 100%; overflow: hidden;">
                        ...
                        box-shadow: 0px 0px 20px -20px rgba(0, 0, 0, 0.3), 0 0 3px 2px rgba(0, 0, 0, 0.06);"><h2 style="padding: 6px;margin:2px;background:#e6f7e5;">NOTICE BOARD</h2>
                 <?php
                               
 $query = "SELECT * FROM hmglrey WHERE cid=3";
...
<a class="btn" href="addpost.php?nid=1">ADD NOTICE</a>
