...
<html>
    <head>
        <link rel="icon" href="zmadminschool/img/logo.jpg">
        ...
        <section>
            <nav class="">
                ...
                <div class="nav1 smnone bgcolor">
                        ...
                        $query = "SELECT * FROM themetext WHERE id=$id";
                        $getData = $db->select($query)->fetch_assoc();
                        echo $getData['text'];?></p></div>
                        <div class="nav1right"><a class="fl-r" href="https://www.facebook.com/md.hg.tushar/" target="blank"> Developer</a></div>
                    </div>                    
                </div>
                    <div class="container">
                <div class="nav2">
                        <div>
                            <div class="logoimg"><img src="zmadminschool/img/logo.jpg" alt=""></div>
                            <a href="admit.php" class="smnone"><img style="height: 70px;float: right;" src="zmadminschool/img/shivam.jpg" alt=""></a>
